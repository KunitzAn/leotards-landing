    ...
    <div className="page">
      <header className="header">
        <div className="container">
          ...
          <p className="tagline">Купальники для художественной, эстетической гимнастики, фигурного катания и других видов спорта</p>
        </div>
      </header>
    ...
    <div className="page">
      ...
      <main>
        ...
        <section className="container content">
          ...
          <div className="note">
            Стоимость пошива — от 35 000 ₽. Актуальные цены на ваш рост необходимо уточнять. 
          </div>
          <div className="note">
            Всегда в наличии костюмы в свободною продаже. Стоимоть от 28 000 ₽. 
          </div>
          <ul className="list">
        ...
        <section className="container content">
          ...
          <ul className="list">
            ...
            <li>Минимальная стоимость купальника — от 35 000 ₽. Актуальные цены на ваш рост необходимо уточнять.</li>
          </ul>
